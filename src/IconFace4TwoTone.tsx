...
const IconFace4TwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M4.42,9.47L4.42,9.47C6.13,8.5,7.45,6.92,8.08,5.03C6.37,6,5.05,7.58,4.42,9.47z"
          opacity=".3"
        />
        <path
          d="M17.5,8c0.46,0,0.91-0.05,1.34-0.12C17.44,5.56,14.9,4,12,4c-0.46,0-0.91,0.05-1.34,0.12h0 C12.06,6.44,14.6,8,17.5,8z"
          opacity=".3"
        />
        <path
          d="M7.35,3.15C6.8,2.46,5.95,2,5,2C3.35,2,2,3.35,2,5c0,0.95,0.46,1.8,1.15,2.35 C4.09,5.56,5.56,4.09,7.35,3.15z"
          opacity=".3"
        />
...
export { IconFace4TwoTone as default }
