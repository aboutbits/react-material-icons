...
const IconGroups2TwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M15.43,15.48c-1.1-0.49-2.26-0.73-3.43-0.73c-1.18,0-2.33,0.25-3.43,0.73c-0.23,0.1-0.4,0.29-0.49,0.52 h7.85C15.83,15.77,15.66,15.58,15.43,15.48z"
          opacity=".3"
        />
        <path
          d="M12.94,8.79C12.86,8.33,12.47,8,12,8s-0.86,0.33-0.94,0.79L10.86,10h2.28L12.94,8.79z"
          opacity=".3"
        />
...
export { IconGroups2TwoTone as default }
