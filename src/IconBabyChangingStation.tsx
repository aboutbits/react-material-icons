...
const IconBabyChangingStation: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    <title>
      {props.title === undefined ? 'IconBabyChangingStation' : props.title}
    </title>
    <g>
...
export { IconBabyChangingStation as default }
