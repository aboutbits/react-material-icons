...
const IconCircleNotificationsTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <path
        d="M12,4c-4.41,0-8,3.59-8,8s3.59,8,8,8c4.41,0,8-3.59,8-8S16.41,4,12,4z M12,18.5 c-0.83,0-1.5-0.67-1.5-1.5h3C13.5,17.83,12.83,18.5,12,18.5z M17,16H7v-2h1v-2.61C8,9.27,9.03,7.47,11,7V6.5c0-0.57,0.43-1,1-1 s1,0.43,1,1V7c1.97,0.47,3,2.28,3,4.39V14h1V16z"
...
export { IconCircleNotificationsTwoTone as default }
