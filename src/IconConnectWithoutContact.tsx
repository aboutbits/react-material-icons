...
const IconConnectWithoutContact: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    <title>
      {props.title === undefined ? 'IconConnectWithoutContact' : props.title}
    </title>
...
export { IconConnectWithoutContact as default }
