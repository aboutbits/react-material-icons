...
const IconBrowserNotSupported: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    <title>
      {props.title === undefined ? 'IconBrowserNotSupported' : props.title}
    </title>
    <g>
...
export { IconBrowserNotSupported as default }
