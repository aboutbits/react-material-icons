...
const IconEmojiTransportation: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    <title>
      {props.title === undefined ? 'IconEmojiTransportation' : props.title}
    </title>
    <g>
...
export { IconEmojiTransportation as default }
