...
const IconDisabledVisibleTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <path
      d="M17,15c-1.95,0-3.76,0.98-4.75,2.5C13.24,19.02,15.05,20,17,20s3.76-0.98,4.75-2.5 C20.76,15.98,18.95,15,17,15z M17,19c-0.83,0-1.5-0.67-1.5-1.5c0-0.83,0.67-1.5,1.5-1.5s1.5,0.67,1.5,1.5C18.5,18.33,17.83,19,17,19 z"
      opacity=".3"
    />
...
export { IconDisabledVisibleTwoTone as default }
