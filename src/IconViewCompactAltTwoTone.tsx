...
const IconViewCompactAltTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M4,18h16V6H4V18z M12.5,7.5h4v4h-4V7.5z M12.5,12.5h4v4h-4V12.5z M7.5,7.5h4v4h-4V7.5z M7.5,12.5h4v4h-4 V12.5z"
          opacity=".3"
        />
...
export { IconViewCompactAltTwoTone as default }
