...
const IconHiveTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <polygon
          opacity=".3"
          points="5.92,7 4.79,9 5.92,11 8.06,11 9.19,9 8.06,7"
        />
        <polygon
          opacity=".3"
          points="10.94,16 9.8,18.02 10.92,20 13.08,20 14.2,18.02 13.06,16"
        />
        <polygon
          opacity=".3"
          points="13.06,14 14.19,12 13.06,10 10.94,10 9.81,12 10.94,14"
        />
        <polygon
          opacity=".3"
          points="5.92,13 4.79,15 5.92,17 8.06,17 9.19,15 8.06,13"
        />
        <polygon
          opacity=".3"
          points="15.94,7 14.81,9 15.94,11 18.08,11 19.21,9 18.08,7"
        />
        <polygon
          opacity=".3"
          points="10.92,4 9.8,5.98 10.94,8 13.06,8 14.2,5.98 13.08,4"
        />
        <polygon
          opacity=".3"
          points="15.94,13 14.81,15 15.94,17 18.08,17 19.21,15 18.08,13"
        />
...
export { IconHiveTwoTone as default }
