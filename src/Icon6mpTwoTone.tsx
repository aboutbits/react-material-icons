...
const Icon6mpTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        ...
        <path
          d="M5,19h14V5H5V19z M18,13.5V16c0,0.55-0.45,1-1,1h-2v1.5h-1.5v-6H17C17.55,12.5,18,12.95,18,13.5z M10,6.5 c0-0.55,0.45-1,1-1h3.5V7h-3v1h2c0.55,0,1,0.45,1,1v1.5c0,0.55-0.45,1-1,1H11c-0.55,0-1-0.45-1-1V6.5z M6,13.5c0-0.55,0.45-1,1-1 h4.5c0.55,0,1,0.45,1,1v5H11V14h-1v3H8.5v-3h-1v4.5H6V13.5z"
          opacity=".3"
        />
...
export { Icon6mpTwoTone as default }
