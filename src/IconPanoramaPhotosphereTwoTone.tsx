...
const IconPanoramaPhotosphereTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M3,9.91l0,4.18c0,0,0,0,0,0C5.19,15.3,8.47,16,12,16c3.53,0,6.81-0.69,9-1.91l0-4.18c0,0,0,0,0,0 C18.81,8.7,15.53,8,12,8C8.47,8,5.2,8.69,3,9.91z"
          opacity=".3"
        />
...
export { IconPanoramaPhotosphereTwoTone as default }
