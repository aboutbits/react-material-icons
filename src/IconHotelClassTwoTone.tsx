...
const IconHotelClassTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <polygon
      opacity=".3"
      points="11,8.89 11.94,12 14.76,12 12.49,13.62 13.42,16.63 11,14.79 8.58,16.63 9.51,13.62 7.24,12 10.06,12"
    />
...
export { IconHotelClassTwoTone as default }
