...
const IconAnimationTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M5,12c-0.63,0.84-1,1.88-1,3c0,2.76,2.24,5,5,5c1.12,0,2.16-0.37,3-1C8.13,19,5,15.87,5,12z"
          opacity=".3"
        />
        <path
          d="M15,4c-1.13,0-2.16,0.37-3,1c3.87,0.01,7,3.14,7,7c0.63-0.84,1-1.88,1-3C20,6.24,17.76,4,15,4z"
          opacity=".3"
        />
        <path
          d="M12,7c-0.6,0-1.17,0.11-1.7,0.3C10.11,7.83,10,8.4,10,9c0,2.76,2.24,5,5,5c0.6,0,1.17-0.11,1.7-0.3 c0.19-0.53,0.3-1.1,0.3-1.7C17,9.24,14.76,7,12,7z"
          opacity=".3"
        />
        <path
          d="M8,9c-0.63,0.84-1,1.88-1,3c0,2.76,2.24,5,5,5c1.12,0,2.16-0.37,3-1C11.13,15.99,8,12.86,8,9z"
          opacity=".3"
        />
...
export { IconAnimationTwoTone as default }
