...
const IconPublishedWithChanges: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    <title>
      {props.title === undefined ? 'IconPublishedWithChanges' : props.title}
    </title>
...
export { IconPublishedWithChanges as default }
