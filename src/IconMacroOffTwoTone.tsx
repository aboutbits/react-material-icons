...
const IconMacroOffTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M10.11,5.69L9.3,5.13C9.12,5,8.89,4.93,8.66,4.93c-0.25,0-0.47,0.1-0.66,0.24 l1.39,1.39C9.57,6.23,9.82,5.93,10.11,5.69z"
          enableBackground="new"
          opacity=".3"
        />
        <path
          d="M15.83,8.9l-0.88-0.42c-0.12,0.73-0.51,1.36-1.05,1.82l0.8,0.57 c0.18,0.13,0.4,0.2,0.64,0.2c0.47,0,0.87-0.28,1.05-0.69c0.06-0.14,0.09-0.28,0.09-0.44C16.49,9.49,16.23,9.1,15.83,8.9z"
          enableBackground="new"
          opacity=".3"
        />
        <path
          d="M13.89,5.68c0.55,0.46,0.94,1.1,1.06,1.84l0.87-0.42 c0.41-0.2,0.66-0.59,0.66-1.03c0-0.63-0.51-1.14-1.14-1.14c-0.24,0-0.46,0.07-0.64,0.2L13.89,5.68z"
          enableBackground="new"
          opacity=".3"
        />
        <path
          d="M12,5c0.36,0,0.71,0.07,1.03,0.19l0.11-1.09C13.12,3.49,12.62,3,12,3 s-1.12,0.49-1.14,1.1l0.12,1.09C11.3,5.07,11.64,5,12,5z"
          enableBackground="new"
          opacity=".3"
        />
        <path
          d="M15.94,18.77l-0.71-0.71c-0.32,0.47-0.59,0.97-0.79,1.5 C14.98,19.36,15.48,19.09,15.94,18.77z"
          enableBackground="new"
          opacity=".3"
        />
        <path
          d="M5.44,15.44c0.71,1.9,2.22,3.41,4.12,4.12C8.85,17.66,7.34,16.15,5.44,15.44z"
          enableBackground="new"
          opacity=".3"
        />
        ...
        <path d="M19.98,17.15C20.63,15.91,21,14.5,21,13c-1.5,0-2.91,0.37-4.15,1.02l1.51,1.51" />
...
export { IconMacroOffTwoTone as default }
