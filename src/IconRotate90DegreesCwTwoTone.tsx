...
const IconRotate90DegreesCwTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
      ...
      <g>
        <g>
          ...
          <rect
            ...
            height="4.49"
            opacity=".3"
            transform="matrix(0.7071 -0.7071 0.7071 0.7071 -4.2138 15.8229)"
            width="4.49"
            x="14.75"
            y="10.75"
          />
...
export { IconRotate90DegreesCwTwoTone as default }
