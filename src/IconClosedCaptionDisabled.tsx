...
const IconClosedCaptionDisabled: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    <title>
      {props.title === undefined ? 'IconClosedCaptionDisabled' : props.title}
    </title>
...
export { IconClosedCaptionDisabled as default }
