...
const IconTwoWheeler: React.FC<IconProps> = (props) => (
  <svg
    ...
    {...props}
  >
    <title>{props.title === undefined ? 'IconTwoWheeler' : props.title}</title>
    <g>
      <rect fill="none" fillRule="evenodd" height="24" width="24" x="0" y="0" />
...
export { IconTwoWheeler as default }
