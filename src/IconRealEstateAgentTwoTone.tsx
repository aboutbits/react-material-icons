...
const IconRealEstateAgentTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <path
      d="M10.5,9.44l5.32,1.99c1.24,0.46,2.21,1.41,2.74,2.57L19,14V7.5L14,4L9,7.5V9h0.33L10.5,9.44z M14.5,7h1v1h-1 V7z M14.5,9h1v1h-1V9z M12.5,7h1v1h-1V7z M12.5,9h1v1h-1V9z M3,13h2v7H3V13z M19.9,18.57l-5.93,1.84L7,18.48V13h1.61l5.82,2.17 C14.77,15.3,15,15.63,15,16c0,0-1.99-0.05-2.3-0.15l-2.38-0.79l-0.63,1.9l2.38,0.79c0.51,0.17,1.04,0.26,1.58,0.26H19 C19.39,18.01,19.74,18.24,19.9,18.57z"
      opacity=".3"
    />
...
export { IconRealEstateAgentTwoTone as default }
