...
const IconGroupRemoveTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <path
      d="M8,10c-1.1,0-2-0.9-2-2s0.9-2,2-2s2,0.9,2,2S9.1,10,8,10z M14,18H2v-0.99C2.2,16.29,5.3,15,8,15s5.8,1.29,6,2 V18z"
      opacity=".3"
    />
...
export { IconGroupRemoveTwoTone as default }
