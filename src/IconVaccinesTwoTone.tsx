...
const IconVaccinesTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <path
      d="M19,17h-4v-1.5h4V17z M9,7.5H5V15h4l0-1.5H7.25c-0.41,0-0.75-0.34-0.75-0.75C6.5,12.34,6.84,12,7.25,12H9 v-1.5H7.25c-0.41,0-0.75-0.34-0.75-0.75C6.5,9.34,6.84,9,7.25,9H9V7.5z"
      opacity=".3"
    />
...
export { IconVaccinesTwoTone as default }
