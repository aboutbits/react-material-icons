...
const IconMonitorHeartTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M15.11,12.45L14,10.24l-3.11,6.21C10.72,16.79,10.38,17,10,17s-0.72-0.21-0.89-0.55L7.38,13H2v2h2v3h16v-3 h2v-2h-6C15.62,13,15.28,12.79,15.11,12.45z"
          opacity=".3"
        />
        <path
          d="M20,6H4v3H2v2h6c0.38,0,0.72,0.21,0.89,0.55L10,13.76l3.11-6.21c0.34-0.68,1.45-0.68,1.79,0L16.62,11H22V9 h-2V6z"
          opacity=".3"
        />
...
export { IconMonitorHeartTwoTone as default }
