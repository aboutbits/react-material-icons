...
const IconMiscellaneousServices: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    <title>
      {props.title === undefined ? 'IconMiscellaneousServices' : props.title}
    </title>
    <g>
...
export { IconMiscellaneousServices as default }
