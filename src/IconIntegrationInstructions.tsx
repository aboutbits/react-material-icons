...
const IconIntegrationInstructions: React.FC<IconProps> = (props) => (
  <svg
  ...
  >
    <title>
      {props.title === undefined ? 'IconIntegrationInstructions' : props.title}
    </title>
    <g>
...
export { IconIntegrationInstructions as default }
