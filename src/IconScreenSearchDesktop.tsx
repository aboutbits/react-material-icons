...
const IconScreenSearchDesktop: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <g>
          <rect height="1.8" fill="none" width="4.8" x="9.6" y="16.8" />
        ...
        <rect height="24" fill="none" width="24" />
      </g>
    </g>
  </svg>
)

export { IconScreenSearchDesktop as default }
