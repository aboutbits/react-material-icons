...
const IconSettingsSystemDaydream: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <title>
      {props.title === undefined ? 'IconSettingsSystemDaydream' : props.title}
    </title>
...
export { IconSettingsSystemDaydream as default }
