...
const IconPermContactCalendar: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <title>
      {props.title === undefined ? 'IconPermContactCalendar' : props.title}
    </title>
...
export { IconPermContactCalendar as default }
