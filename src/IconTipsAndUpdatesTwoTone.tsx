...
const IconTipsAndUpdatesTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <path
      d="M14.5,9.5C14.5,6.47,12.03,4,9,4S3.5,6.47,3.5,9.5c0,2.47,1.49,3.89,2.35,4.5h6.3 C13.01,13.39,14.5,11.97,14.5,9.5z"
      opacity=".3"
    />
...
export { IconTipsAndUpdatesTwoTone as default }
