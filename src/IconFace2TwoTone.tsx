...
const IconFace2TwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M6.02,5C6.01,5,6.01,5,6,5C3.79,5,2,6.79,2,9c0,0.55,0.12,1.07,0.32,1.54C2.89,8.29,4.22,6.35,6.02,5z"
          opacity=".3"
        />
        <path
          d="M15.1,3.5C14.36,2.59,13.25,2,12,2S9.64,2.59,8.9,3.5C9.88,3.18,10.92,3,12,3S14.12,3.18,15.1,3.5z"
          opacity=".3"
        />
        <path
          d="M12,5.31c0,2.24,1.82,4.06,4.06,4.06c0.93,0,1.82-0.32,2.53-0.89C17.16,6.39,14.75,5.01,12.03,5 C12.02,5.11,12,5.21,12,5.31z"
          opacity=".3"
        />
        <path
          d="M2.5,16.12C2.19,16.68,2,17.31,2,18c0,2.21,1.79,4,4,4c0.44,0,0.85-0.07,1.25-0.2 C5.02,20.59,3.31,18.56,2.5,16.12z"
          opacity=".3"
        />
        <path
          d="M21.68,10.54C21.88,10.07,22,9.55,22,9c0-2.21-1.79-4-4-4c-0.01,0-0.01,0-0.02,0 C19.78,6.35,21.11,8.29,21.68,10.54z"
          opacity=".3"
        />
        <path
          d="M16.75,21.8C17.15,21.93,17.56,22,18,22c2.21,0,4-1.79,4-4c0-0.69-0.19-1.32-0.5-1.88 C20.69,18.56,18.98,20.59,16.75,21.8z"
          opacity=".3"
        />
...
export { IconFace2TwoTone as default }
