...
const IconVolcanoTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <polygon
          opacity=".3"
          points="16.49,10 12.35,10 10.86,13.74 10.35,15 9,15 7.3,15 5.08,20 19.35,20"
        />
        <g>
...
export { IconVolcanoTwoTone as default }
