...
const IconGroupAddTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M8,15c-2.7,0-5.8,1.29-6,2.01V18h12v-1C13.8,16.29,10.7,15,8,15z"
          enableBackground="new"
          opacity=".3"
        />
        <circle cx="8" cy="8" enableBackground="new" opacity=".3" r="2" />
...
export { IconGroupAddTwoTone as default }
