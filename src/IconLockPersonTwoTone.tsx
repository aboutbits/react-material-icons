...
const IconLockPersonTwoTone: React.FC<IconProps> = ({ ...props }) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <path
          d="M6,10v10h5.29C11.1,19.37,11,18.7,11,18c0-3.87,3.13-7,7-7v-1H6z"
          opacity=".3"
        />
...
export { IconLockPersonTwoTone as default }
